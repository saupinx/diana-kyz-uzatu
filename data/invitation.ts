...
export const invitation: Record<Language, InvitationContent> = {
  ru: {
    ...
    invitationText:
      "Приглашаем Вас быть почетным гостем на қыз ұзату нашей дочери Дианы.",
    guestArrival: "17:00",
    start: "18:00",
    date: "05.08.2026",
    venue: "Ресторан Фазенда",
    city: "Косшы",
    address: "Акмолинская область  район Косшы улица Исатай Тайманова 31",
    childrenNote:
  ...
  kz: {
    ...
    city: "Қосшы",
    address: "Акмола обласы Косшы ауданы, Исатай Тайманова көшесі 31",
    childrenNote:
